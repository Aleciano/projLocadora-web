 ...
 *
 *Cliente � um objeto filho de pessoa que herda todos os atributos de pessoa
 *Ele � responsavel por representar os clientes de uma locadora de video  
 *
 */
...
public class Cliente extends Pessoa {
	 ...
	 * @param email endere�o eletr�nico do cliente
	 * @param fone numero do telefone residencial do cliente 
	 * @param celular numero do telefone m�vel do cliente
	 */
